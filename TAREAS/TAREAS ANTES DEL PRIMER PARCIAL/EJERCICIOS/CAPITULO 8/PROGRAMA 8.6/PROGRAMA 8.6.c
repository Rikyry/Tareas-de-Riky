    ...
    while (OPE)
    {
        switch (OPE)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                Nuevos_Productos(INV, &TAM); /* Se pasa el parametro por referencia, porque se puede modificar el numero de elementos del arreglo en la funcion. */
                break;
            case 4:
                Inventario(INV, TAM);
                break;
...
/* Esta funcion se utiliza para reabastecer el inventario. */
{
    int CLA, CAN, I;
    printf("\nIngrese clave del producto -0 para salir-: ");
    scanf("%d", &CLA);
